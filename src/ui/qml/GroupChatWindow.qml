...
ApplicationWindow {
    ...
    property alias contact: groupChatPage.contact
    signal closed
    ...
    onClosed: {
        ...
        if (!uiSettings.data.combinedChatWindow)
            groupChatPage.conversationModel.clear()
    }
    ...
    Timer {
        id: retakeFocus
        onTriggered: groupChatPage.forceActiveFocus()
        interval: 1
    }
    ...
    Action {
        ...
        onTriggered: groupChatWindow.close()
    }
}
